...
class CalculationTestCase(unittest.TestCase):
    ...
    def test_15(self):
        result = formula_Bernoulli(5, 3, 0.5)
        self.assertEqual(result, 0.3125)

    def test_16(self):
        result = arithmetic_progression(5, 2, 2, 1)
        self.assertEqual(result, 7)

    def test_17(self):
        result = arithmetic_progression(5, 2, 2, 2)
        self.assertEqual(result, 12)

    def test_18(self):
        result = geometric_progression(2, 3, 4, 1)
        self.assertEqual(result, 54)

    def test_19(self):
        result = geometric_progression(2, 3, 4, 2)
